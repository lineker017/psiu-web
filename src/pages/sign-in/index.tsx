        ...
        <div className="w-full bg-zinc-800 py-12 px-20 rounded-sm">
          ...
          <form className="mt-6 space-y-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="h-10 w-full rounded-md bg-transparent text-zinc-400 text-sm border-2 border-zinc-600 outline-none px-4 focus:border-yellow-500"
                />
            ...
            <div className="flex flex-col items-center gap-3">
              <button className="py-2 w-full bg-yellow-500 rounded-md font-semibold text-zinc-900">
                ENTRAR
              </button>
